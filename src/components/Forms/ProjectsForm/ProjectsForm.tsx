...
const ProjectsForm = () => {
  ...
  const {
    ...
    defaultValues: {
      project: [{ name: "", techStack: "", listDescription: [""] }],
    },
    mode: "onChange",
  });
  ...
  const onSubmit = (values: z.infer<typeof ProjectsSchema>) => {
    const filteredValues = values.project.map((project) => ({
      ...project,
      listDescription: project.listDescription.filter((p) => p != ""),
    }));
    saveData({
  ...
  return (
    <div className="min-h-[70%] bg-white border-1 border-gray-300 border-t-blue-400 border-t-4 dark:bg-neutral-800 shadow-lg rounded-lg p-6 lg:p-10 w-full">
      <form
        className="gap-6 max-h-[485px] overflow-y-auto custom-scrollbar pr-5"
      ...
      >
        <div>
            ...
            <div>
              {currentIndex > 0 && (
                <button
                  ...
                  className="text-red-500 border border-gray-200 bg-white px-4 py-2 rounded-lg"
                >
                  -
                </button>
              )}
              {fields.length < 6 && (
                <button
                  onClick={addProject}
                  className="text-blue-500 border border-gray-200 bg-white px-4 py-2 rounded-lg"
                >
                  +
                </button>
              )}
          ...
          <div className="mt-1 grid grid-cols-2 gap-2">
            <div className="w-full">
              ...
              <input
                ...
                type="text"
              />
              {errors?.project?.[currentIndex]?.name && (
            ...
            <div className="w-full">
              ...
              />
              {errors?.project?.[currentIndex]?.techStack && (
                <p className="text-red-500 text-sm mt-1">
                  This field is required
                </p>
              )}
            ...
            <div className="w-full">
              ...
              <input
                ...
                type="text"
                {...register(`project.${currentIndex}.demo`, {
                  required: false,
                })}
              />
            </div>
            <div className="w-full">
              ...
              <input
                ...
                type="text"
                {...register(`project.${currentIndex}.repository`, {
                  required: false,
                })}
              />
            </div>
          ...
          <div className="mt-5">
            <div className="flex items-center gap-1">
              <label className="font-bold text-gray-700">
                Describe your project in points
              </label>
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    Describe your project, and if you feel unsure, let AI
                    improve it!
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            {descriptionArray?.map((_, index) => (
              <div key={index} className="flex my-4 items-center gap-1">
                {loading === true && index === indexDescription ? (
                  <div className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-indigo-500 focus:ring-indigo-500">
                  ...
                  <input
                    ...
                    type="text"
                    placeholder={
                      EXAMPLES_PROJECTS[index]
                        ? EXAMPLES_PROJECTS[index]
                        : "Put a litle description..."
                    }
                    {...register(
                      `project.${currentIndex}.listDescription.${index}`
                    )}
                  />
                )}
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger className="border-black/20 text-black/40">
                      <Button
                        ...
                        onClick={() =>
                          betterTextWithAI(
                            prompt +
                              values?.project[currentIndex]?.listDescription[
                                index
                              ],
                            index
                          )
                    ...
                    <TooltipContent>
                      <p className="text-sm">
                        Put a description and click here to generate a better
                        text w/AI!
                      </p>
                    </TooltipContent>
                  </Tooltip>
          ...
          <div className="flex gap-2 justify-start mb-10">
            <Button
              onClick={addArray}
              type="button"
              className="text-blue-400 border-1 bg-white border-gray-200 hover:bg-inherit"
              size={"lg"}
            >
            ...
            <Button
              onClick={removeArray}
              type="button"
              className="text-red-400 border-1 bg-white border-gray-200 hover:bg-inherit"
              size={"lg"}
            >
              - Remove Description
            </Button>
        ...
        <div className="flex justify-end mt-10">
          <Button
            ...
            onClick={() => updateCurrentSection("works")}
            size={"sm"}
          >
            <MoveRight /> Continue
          </Button>
