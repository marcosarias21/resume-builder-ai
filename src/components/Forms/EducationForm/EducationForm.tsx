...
const EducationForm = () => {
  ...
  const {
    ...
    defaultValues: {
      educations: [
        { universityName: "", degree: "", major: "", start: "", end: "" },
      ],
    },
  });
  ...
  useSetFormValues("educations", "educations", setValue);
  ...
  return (
    <div className="min-h-[70%] bg-white border-1 border-gray-300 border-t-blue-400 border-t-4 dark:bg-neutral-800 shadow-lg rounded-lg p-6 lg:p-10 w-full">
      <form
        ...
        className="gap-6 min-h-[100%] max-h-[480px] overflow-y-auto custom-scrollbar pr-5"
      >
        <div>
          {fields.map((_, index) => (
