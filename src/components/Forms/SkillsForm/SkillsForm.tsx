              ...
              <div key={index} className="mb-1">
                <div className="flex justify-between border-1 rounded-2xl p-5">
                  <div className="flex flex-col p-1 w-full">
                    ...
                    <input className='font-medium py-3 px-4 block w-full border-1 border-gray-200 rounded-lg text-sm ffocus:border-green-400 focus:ring-1 focus:ring-green-400 focus:outline-none dark:text-white dark:placeholder-gray-400'
